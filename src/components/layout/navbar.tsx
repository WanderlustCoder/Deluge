    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "text-storm-light hover:text-storm hover:bg-gray-100"
                  )}
                >
            ...
            {session?.user && (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-sm text-storm-light hover:text-red-500 transition-colors"
                >
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden p-2 rounded-lg text-storm hover:bg-gray-100"
