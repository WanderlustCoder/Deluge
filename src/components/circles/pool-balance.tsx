    ...
    >
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between text-sm mb-2">
          <span className="text-storm-light dark:text-dark-text-secondary">Deployment Rate</span>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gray-50 dark:bg-foam/5 rounded-lg p-3 text-center">
          ...
          <p className="text-xs text-storm-light dark:text-dark-text-secondary">Total Contributed</p>
        </div>
        <div className="bg-gray-50 dark:bg-foam/5 rounded-lg p-3 text-center">
          ...
          <p className="text-xs text-storm-light dark:text-dark-text-secondary">Total Deployed</p>
        </div>
      </div>

      {monthlyContributions > 0 && (
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-foam/10 text-center">
          <p className="text-sm text-storm-light dark:text-dark-text-secondary">
