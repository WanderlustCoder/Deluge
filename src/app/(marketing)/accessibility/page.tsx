    ...
    <div className="min-h-screen bg-foam dark:bg-storm">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-xl text-storm/80 dark:text-foam/80 mb-8">
          ...
          <h2 className="text-2xl font-bold text-storm dark:text-foam mt-8 mb-4">
            Our Commitment
          </h2>
          <p className="text-storm/80 dark:text-foam/80 mb-4">
            We strive to meet{' '}
          ...
          <ul className="text-storm/80 dark:text-foam/80 space-y-2 mb-6">
            <li>
          ...
          <div className="bg-storm/5 dark:bg-storm/20 rounded-lg p-6 mt-8">
