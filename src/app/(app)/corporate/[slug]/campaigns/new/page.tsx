      ...
      >
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-storm-light dark:text-dark-text-secondary">
              $
            </span>
            <input
              type="number"
        ...
        {/* Submit */}
        <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-foam/10">
          <Link
            href={`/corporate/${slug}/campaigns`}
            className="px-4 py-2 text-storm-light dark:text-dark-text-secondary hover:text-storm dark:hover:text-dark-text transition-colors"
          >
            Cancel
          </Link>
          <button
