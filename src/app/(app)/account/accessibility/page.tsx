  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="space-y-8">
        {/* Text Size */}
        <section>
          <h2 className="text-xl font-semibold text-storm dark:text-dark-text mb-4">Text Size</h2>
          <div className="grid sm:grid-cols-2 gap-3">
            {FONT_SIZES.map((size) => (
              ...
              >
                <p className={`font-medium text-storm dark:text-dark-text ${size.sample}`}>
                  {size.label}
                </p>
                <p className={`text-storm-light dark:text-dark-text-secondary ${size.sample}`}>
                  Sample text
                </p>
              </motion.button>
            ))}
        ...
        {/* Font Family */}
        <section>
          <h2 className="text-xl font-semibold text-storm dark:text-dark-text mb-4">Font Style</h2>
          <div className="space-y-3">
            {FONT_FAMILIES.map((font) => (
              ...
              >
                <p className="font-medium text-storm dark:text-dark-text">{font.label}</p>
                <p className="text-sm text-storm-light dark:text-dark-text-secondary">{font.desc}</p>
              </motion.button>
            ))}
          </div>
        </section>
        ...
        {/* Line Spacing */}
        <section>
          <h2 className="text-xl font-semibold text-storm dark:text-dark-text mb-4">Line Spacing</h2>
          <div className="grid grid-cols-3 gap-3">
            {LINE_SPACINGS.map((spacing) => (
              ...
              >
                <p className="font-medium text-storm dark:text-dark-text text-sm">{spacing.label}</p>
              </motion.button>
            ))}
          </div>
        </section>
        ...
        {/* Toggle Options */}
        <section>
          <h2 className="text-xl font-semibold text-storm dark:text-dark-text mb-4">Display Options</h2>
          <div className="space-y-4">
            <label className="flex items-center justify-between p-4 rounded-xl border border-gray-200">
              <div>
                <p className="font-medium text-storm dark:text-dark-text">High Contrast Mode</p>
            ...
            <label className="flex items-center justify-between p-4 rounded-xl border border-gray-200">
              <div>
                <p className="font-medium text-storm dark:text-dark-text">Reduce Motion</p>
                <p className="text-sm text-storm-light dark:text-dark-text-secondary">
            ...
            <label className="flex items-center justify-between p-4 rounded-xl border border-gray-200">
              <div>
                <p className="font-medium text-storm dark:text-dark-text">Screen Reader Optimizations</p>
                <p className="text-sm text-storm-light dark:text-dark-text-secondary">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <h3 className="font-medium text-storm dark:text-dark-text mb-2">Keyboard Shortcuts</h3>
          <ul className="text-sm text-storm-light dark:text-dark-text-secondary space-y-1">
            <li>
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">Tab</kbd> — Move to next
              interactive element
            </li>
            <li>
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">Shift + Tab</kbd> — Move to
              previous element
            </li>
            <li>
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">Enter</kbd> or{' '}
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">Space</kbd> — Activate
              buttons
            </li>
            <li>
              <kbd className="px-2 py-0.5 bg-gray-100 rounded text-xs">Escape</kbd> — Close dialogs
            </li>
          </ul>
        </div>
      </div>
